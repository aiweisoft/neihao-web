    ...
    <view class="page-card">
      <view class="page-header">
        <view class="page-header-left">
          ...
          <view class="page-title">设备分类</view>
        </view>
      ...
      <view class="page-body">
        <unicloud-db ref="udb" collection="medical-device-category" :where="where" page-data="replace" :orderby="orderby"
          ...
          <uni-table ref="table" :loading="loading" border stripe type="selection"
            ...
            <uni-tr>
              <uni-th align="center">分类编码</uni-th>
              <uni-th align="center">分类名称</uni-th>
              <uni-th align="center">排序号</uni-th>
