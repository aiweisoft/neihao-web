    ...
    <view class="page-card">
      <view class="page-header">
        <view class="page-header-left">
          ...
          <view class="page-title">存放位置</view>
        </view>
      ...
      <view class="page-body">
        <unicloud-db ref="udb" collection="medical-device-location" :where="where" page-data="replace" :orderby="orderby"
          ...
          <uni-table ref="table" :loading="loading" border stripe type="selection"
            ...
            <uni-tr>
              <uni-th align="center">位置编码</uni-th>
              <uni-th align="center">位置名称</uni-th>
              <uni-th align="center">楼栋</uni-th>
              <uni-th align="center">楼层</uni-th>
            ...
            <uni-tr v-for="(item, index) in data" :key="index">
              ...
              <uni-td align="center">{{ item.building || '-' }}</uni-td>
              <uni-td align="center">{{ item.floor || '-' }}</uni-td>
              <uni-td align="center">{{ item.room || '-' }}</uni-td>
